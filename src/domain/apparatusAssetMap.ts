...
export const APPARATUS_ICON_FILENAMES: Record<ApparatusCatalogId, ApparatusAssetFilenamePair> = {
  ...
  'interrupteur-poussoir': { black: 'InterrupteurPoussoir_Noir.svg', green: 'InterrupteurPoussoir_Vert.svg' },
  'interrupteur-simple': { black: 'InterrupteurSimple_Noir.svg', green: 'InterrupteurSimple_Vert.svg' },
  'interrupteur-v&v': { black: 'InterrupteurVa&Vient_Noir.svg', green: 'InterrupteurVa&Vient_Vert.svg' },
  'interrupteur-double': { black: 'InterrupteurDoubleS_Noir.svg', green: 'InterrupteurDoubleS_Vert.svg' },
  'Interrupteur-double-v': { black: 'InterrupteurDoubleV_Noir.svg', green: 'InterrupteurDoubleV_Vert.svg' },
  'Interrupteur-double-vV': { black: 'InterrupteurDoubleVV_Noir.svg', green: 'InterrupteurDoubleVV_Vert.svg' },
